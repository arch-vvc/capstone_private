...
EXPECTED_OUTPUTS = {
    ...
    7:  ["models/gnn_autoencoder.pth", "models/node_embeddings.pkl", "output/gnn_risk_scores.csv",
         "output/gnn_injection_eval.json", "output/gnn_injection_metrics.txt",
    ...
    11: ["models/ppo_routing_agent.pth", "output/ppo_routing_results.txt", "output/ppo_routing_stats.json",
         "output/ppo_pool_sweep.json", "output/figures/fig9_ppo_training.png"],
